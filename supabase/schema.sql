...
--
-- Name: feedback_codes; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: feedback_codes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.feedback_codes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: feedback_codes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: fit_zones; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.fit_zones (
    id integer NOT NULL,
    user_id integer,
    category_id integer,
...
--
-- Name: fit_zones_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.fit_zones_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: fit_zones_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: measurement_instructions; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.measurement_instructions (
    id integer NOT NULL,
    brand_id integer,
    original_term text,
...
--
-- Name: measurement_instructions_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.measurement_instructions_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: measurement_instructions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.measurement_instructions_id_seq OWNED BY public.measurement_instructions.id;


--
-- Name: raw_size_guides; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.raw_size_guides (
    ...
    created_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    uploaded_by integer,
    CONSTRAINT raw_size_guides_fit_type_check CHECK ((fit_type = ANY (ARRAY['Regular'::text, 'Slim'::text, 'Tall'::text, 'Unspecified'::text]))),
    CONSTRAINT raw_size_guides_gender_check CHECK ((gender = ANY (ARRAY['Male'::text, 'Female'::text, 'Unisex'::text])))
);


--
-- Name: raw_size_guides_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.raw_size_guides_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: raw_size_guides_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: size_guide_entries; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.size_guide_entries (
    id integer NOT NULL,
...
--
-- Name: size_guide_entries_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.size_guide_entries_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: size_guide_entries_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.size_guides (
    ...
    updated_by integer,
    unit text DEFAULT 'in'::text,
    CONSTRAINT size_guides_fit_type_check CHECK ((fit_type = ANY (ARRAY['Regular'::text, 'Slim'::text, 'Tall'::text, 'Unspecified'::text]))),
...
CREATE TABLE public.standardization_log (
    id integer NOT NULL,
    brand_id integer,
...
--
-- Name: standardization_log_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.standardization_log_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: standardization_log_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: user_garment_feedback; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.user_garments (
    ...
    updated_at timestamp without time zone,
    updated_by integer,
    CONSTRAINT user_garments_fit_type_check CHECK ((fit_type = ANY (ARRAY['Regular'::text, 'Slim'::text, 'Tall'::text, 'NA'::text]))),
...
--
-- Name: feedback_codes id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: fit_zones id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: measurement_instructions id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.measurement_instructions ALTER COLUMN id SET DEFAULT nextval('public.measurement_instructions_id_seq'::regclass);


--
-- Name: raw_size_guides id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: size_guide_entries id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: standardization_log id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: user_garment_feedback id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: user_garments id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: feedback_codes feedback_codes_feedback_text_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: feedback_codes feedback_codes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fit_zones fit_zones_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: measurement_instructions measurement_instructions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.measurement_instructions
    ADD CONSTRAINT measurement_instructions_pkey PRIMARY KEY (id);


--
-- Name: raw_size_guides raw_size_guides_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: size_guide_entries size_guide_entries_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: size_guide_entries size_guide_entries_size_guide_id_size_label_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: size_guides size_guides_brand_id_gender_category_id_fit_type_version_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: standardization_log standardization_log_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_garment_feedback user_garment_feedback_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_garments user_garments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
ALTER TABLE ONLY public.admin_activity_log
    ADD CONSTRAINT admin_activity_log_admin_id_fkey FOREIGN KEY (admin_id) REFERENCES public.admins(id);
...
--
-- Name: brands brands_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fit_zones fit_zones_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fit_zones fit_zones_subcategory_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: fit_zones fit_zones_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: measurement_instructions measurement_instructions_brand_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.measurement_instructions
    ADD CONSTRAINT measurement_instructions_brand_id_fkey FOREIGN KEY (brand_id) REFERENCES public.brands(id) ON DELETE CASCADE;


--
-- Name: measurement_instructions measurement_instructions_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.measurement_instructions
    ADD CONSTRAINT measurement_instructions_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.admins(id);


--
-- Name: raw_size_guides raw_size_guides_brand_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: raw_size_guides raw_size_guides_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: raw_size_guides raw_size_guides_subcategory_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: raw_size_guides raw_size_guides_uploaded_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: size_guide_entries size_guide_entries_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: size_guide_entries size_guide_entries_size_guide_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: size_guide_entries size_guide_entries_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: size_guides size_guides_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: size_guides size_guides_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: standardization_log standardization_log_brand_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: standardization_log standardization_log_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: subcategories subcategories_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: subcategories subcategories_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_garment_feedback user_garment_feedback_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_garment_feedback user_garment_feedback_feedback_code_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_garment_feedback user_garment_feedback_user_garment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_garments user_garments_brand_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_garments user_garments_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_garments user_garments_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_garments user_garments_size_guide_entry_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_garments user_garments_size_guide_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_garments user_garments_subcategory_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_garments user_garments_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_garments user_garments_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
