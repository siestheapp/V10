...
Automatically tracks schema changes in the tailor3 database by:
...
This file tracks all schema and structural changes to the `tailor3` database, automatically generated by schema_evolution.py.
