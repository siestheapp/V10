...
11	user_garments	Stores garments a user has scanned or added for fit tracking.	["brand_id", "created_at", "owns_garment", "user_id", "id", "product_name", "product_url", "category", "size_label", "chest_range", "fit_feedback"]
...
COPY public.user_garments (id, user_id, brand_id, category, size_label, chest_range, fit_feedback, created_at, owns_garment, product_name, product_url) FROM stdin;
1	1	1	Tops	M	39-40	Good Fit	2025-02-17 23:52:16.031871	t	\N	\N
3	1	2	Tops	XL	47	Loose but I Like It	2025-02-18 00:22:32.857724	t	\N	\N
7	1	3	Tops	S	36.0-38.0	Tight but I Like It	2025-02-19 21:59:07.412855	t	Brenan Polo Shirt in Cotton-Linen	\N
8	1	2	Tops	L	N/A	\N	2025-02-21 15:06:49.320078	t	Soft Wash Long-Sleeve T-Shirt	https://bananarepublic.gap.com/browse/product.do?pid=800139112&vid=1#pdp-page-content
9	1	9	Tops	L	N/A	\N	2025-02-21 15:07:37.334847	t	Soft Wash Long-Sleeve T-Shirt	https://bananarepublic.gap.com/browse/product.do?pid=800139112&vid=1#pdp-page-content
\.
...
SELECT pg_catalog.setval('public.user_fit_zones_id_seq', 41, true);
...
SELECT pg_catalog.setval('public.user_garments_id_seq', 9, true);
