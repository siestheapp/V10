...
--
-- Name: refresh_metadata_on_alter_table(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: sync_fit_feedback(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: update_metadata_columns(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: automap; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: automap_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: automap_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: brand_automap; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: brand_automap_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: brand_automap_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: database_metadata; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: database_metadata_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: database_metadata_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: size_guide_mappings; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: size_guide_mappings_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: size_guide_mappings_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: size_guide_sources; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE size_guide_sources; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: size_guide_sources_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: size_guide_sources_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: universal_categories_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: universal_categories_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: user_fit_feedback; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: user_fit_zones_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: user_fit_zones_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: automap id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: brand_automap id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: database_metadata id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: size_guide_mappings id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: size_guide_sources id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: universal_categories id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: user_fit_feedback id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: user_fit_zones id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Data for Name: automap; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: brand_automap; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: database_metadata; Type: TABLE DATA; Schema: public; Owner: -
--
...
10	user_fit_zones	Stores personalized fit zones for users, based on their past feedback.	["tight_min", "user_id", "relaxed_max", "id", "perfect_min", "perfect_max", "category"]
...
3	fit_zones	Stores user fit preferences for recommendations.	["id", "user_id", "waist_min", "waist_max", "chest_min", "chest_max", "sleeve_min", "sleeve_max", "fit_type", "garment_category"]
...
--
-- Data for Name: size_guide_mappings; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: size_guide_sources; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: universal_categories; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: user_fit_feedback; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: user_fit_zones; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.user_fit_zones (id, user_id, category, tight_min, perfect_min, perfect_max, relaxed_max) FROM stdin;
1	1	Tops	\N	38.315	40.685	48.410000000000004
\.


--
-- Data for Name: user_garments; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Name: automap_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: brand_automap_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: database_metadata_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: size_guide_mappings_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: size_guide_sources_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: universal_categories_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: user_fit_feedback_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.user_fit_feedback_id_seq', 7, true);


--
-- Name: user_fit_zones_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.user_fit_zones_id_seq', 25, true);


--
-- Name: user_garments_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.user_garments_id_seq', 6, true);
...
--
-- Name: automap automap_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: automap automap_raw_term_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: brand_automap brand_automap_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: database_metadata database_metadata_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: database_metadata database_metadata_table_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: size_guide_mappings size_guide_mappings_brand_size_guide_reference_universal_ca_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: size_guide_mappings size_guide_mappings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: size_guide_sources size_guide_sources_brand_category_source_url_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: size_guide_sources size_guide_sources_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: brand_automap unique_brand_term_mapping; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: size_guides unique_size_guide; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_fit_zones unique_user_category; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_fit_feedback unique_user_garment_feedback; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: universal_categories universal_categories_category_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_fit_feedback user_fit_feedback_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_fit_zones user_fit_zones_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_fit_feedback update_garment_fit_feedback; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: brand_automap brand_automap_brand_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: size_guide_mappings size_guide_mappings_universal_category_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: size_guide_sources size_guide_sources_brand_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_fit_feedback user_fit_feedback_garment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_fit_feedback user_fit_feedback_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_fit_zones user_fit_zones_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: trigger_refresh_metadata; Type: EVENT TRIGGER; Schema: -; Owner: -
--
...
(user_id, garment_id, overall_fit, chest_fit)
VALUES (
    1,  -- user_id
    (SELECT id FROM user_garments  -- Get Theory garment_id
     WHERE user_id = 1 
     AND brand_id = (SELECT id FROM brands WHERE name = 'Theory')
     AND size_label = 'S'),
    'Tight but I Like It',  -- overall_fit
    'Tight but I Like It'   -- chest_fit
);
