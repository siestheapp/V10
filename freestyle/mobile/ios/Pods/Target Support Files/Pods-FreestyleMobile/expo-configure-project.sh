...
with_node \
  ...
  --target "/Users/seandavey/Downloads/freestyle/mobile/ios/Pods/Target Support Files/Pods-FreestyleMobile/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-application" "expo-asset" "expo-constants" "expo-crypto" "expo-eas-client" "expo-file-system" "expo-font" "expo-keep-awake" "expo-linear-gradient" "expo-router" "expo-secure-store" "expo-sqlite" "expo-updates" "expo-web-browser"
