...
6	18	1	40.00	42.00	38.00	40.00	42.00	44.00	38.00	44.00	2025-02-12 20:37:12.194336	2025-02-12 20:37:12.194336
\.
...
31	\N	475352	L	29.90	2025-02-12 19:29:04.231684
\.
...
SELECT pg_catalog.setval('public.fit_ranges_id_seq', 6, true);
...
SELECT pg_catalog.setval('public.scan_history_id_seq', 31, true);
...
--
-- Name: fit_ranges unique_user_measurement; Type: CONSTRAINT; Schema: public; Owner: v10_user
--

ALTER TABLE ONLY public.fit_ranges
    ADD CONSTRAINT unique_user_measurement UNIQUE (user_id, measurement_type_id);
